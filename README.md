...
NEW BITS:
Liam’s feedback has been taken on board and the IGYB Crew is currently in discussions about whether or not to have a ‘private’ toggle for Superstars, which would allow them to have a username and keep their real name hidden for posts and/or comments. On face value, it does seem like it might be easier for people to post anonymously, but the reverse side is that people shouldn’t have to hide who they are here, and allowing that might detract from the intentions of IGYB. 
That is, if people choose anonymity, does that truly encourage them to be their whole selves? Does that allow our other Superstars to support and get to know them - which is the purpose of the site? Or does it allow them to feel more safe, if that's what they need?
Our team is leaning towards allowing people to make that choice for themselves, but is still TBD. 
